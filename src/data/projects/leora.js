...
function expandRoomPricing(groups) {
  let unit = 0;
  return groups.flatMap(({ count, type, worst, base, best }) =>
    Array.from({ length: count }, () => ({ unit: ++unit, type, worst, base, best })),
  );
}

const strPricing = expandRoomPricing([
  { count: 54, type: "oneBedroom", worst: 10890, base: 12188.86364, best: 13470 },
  { count: 29, type: "twoBedroom", worst: 14490, base: 17571.17647, best: 20670 },
  { count: 3, type: "threeBedroom", worst: 21210, base: 23229.375, best: 25260 },
]);

const ltrPricing = expandRoomPricing([
  { count: 54, type: "oneBedroom", worst: 4200, base: 4500, best: 4900 },
  { count: 29, type: "twoBedroom", worst: 6730, base: 7762.916667, best: 8796 },
  { count: 3, type: "threeBedroom", worst: 8617, base: 9791.666667, best: 10500 },
]);
